package com.ciandt.pizarria.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.ciandt.pizarria.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - Pizzaria")
			.description("Projeto API Spring - Pizarria")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/camillacleanne")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Camilla Cleane", 
			"https://github.com/camillacleanne", 
			"cleanecamilla@gmail.com");
